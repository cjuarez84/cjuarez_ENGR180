...
scene = [
    {'position': np.array([-1, 1, .5]), 'radius': .25, 'color': np.array([1., 0., 0.]), 'reflection': 0.5},
    {'position': np.array([1., -1., .5]), 'radius': 0.25, 'color': np.array([0., 1., 0.]), 'reflection': 0.8},
    {'position': np.array([0, 0, .5]), 'radius': 0.25, 'color': np.array([0., 0., 1.]), 'reflection': 0.1},
